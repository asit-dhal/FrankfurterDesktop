        ...
        , public model::LatestRateModel::Listener
{
 public:
    ...
    void populateDateRangeComboboxes();
    int getLastDayOfMonth(const HistoricalDate &date);
 ...
 private:
    ...
    Label m_historicalStartDateLabel;
    ComboBox m_startDateYearCombobox;
    ComboBox m_startDateMonthCombobox;
    ComboBox m_startDateDayCombobox;
    Label m_historicalEndDateLabel;
    ComboBox m_endDateYearCombobox;
    ComboBox m_endDateMonthCombobox;
    ComboBox m_endDateDayCombobox;
